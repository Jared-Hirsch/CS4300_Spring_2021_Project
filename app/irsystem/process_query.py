...
class QueryProcessor:
    ...
    def process_query(self, query, lyrics_weight, features_weights, n_results, is_uri):
        """
        @returns:
        ...
        """
        return self.sim.main(query, lyrics_weight, features_weights, n_results, is_uri)
